          ...
          <section className="min-w-0 px-2 pb-16 pt-5 md:px-4 md:pt-6 lg:px-8">
            <article className="mx-auto w-full max-w-[998px]">
              ...
              <section
                ...
                className="weekly-comments-panel weekly-surface-strong mt-12 min-w-0 overflow-hidden rounded-[18px] px-4 py-5 md:px-8 md:py-7"
              >
                <h2 id="comments-heading" className="sr-only">
                  {locale === "en-US" ? "Leave a comment" : "写点评论"}
                </h2>
                <div className="weekly-comments-body">
