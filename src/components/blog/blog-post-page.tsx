    ...
    <main className="relative mx-auto max-w-full py-[15px] md:py-[34px]">
      <div className="space-y-[15px] md:space-y-[30px]">
        ...
        <div className="mx-auto w-full max-w-[900px] px-4 md:px-5">
          <article className="bg-[rgba(255,255,255,0.9)] px-5 py-5 md:px-[30px] md:py-[24px] lg:px-[80px] lg:py-[36px]">
            <div
              className={cn(
        ...
        <div className="mx-auto w-full max-w-[900px] px-4 md:px-5">
          <div className="bg-[rgba(255,255,255,0.82)] px-5 py-5 md:px-[30px] md:py-[24px] lg:px-[80px] lg:py-[32px]">
